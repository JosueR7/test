      ...
      <div class="col-9">
        <form class="m-2 needs-validation" method="post" action="#">
          ...
          <div class="row m-2">
            ...
            <div class="col-9">
              <input class="form-control" type="text" name="fullname" id="fullname" placeholder="Nombre completo del empleado" required="required">
            </div>
          </div>
